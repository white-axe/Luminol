...
use super::{
    AudioSelection, DescriptionWidthCallback, EventCommand, EventCommandEditor, EventInfo,
    UpdateState,
};
...
impl EventCommandEditor for Editor {
    ...
    fn description(
        ...
        Some(AudioSelection::new(&command.parameters[0]).fmt())
    }
