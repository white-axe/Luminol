...
toast_error_cannot_load_icon = Cannot load `{$icon_path}` icon: {$why}
...
toast_error_loading_map = Failed to load map: {$why}
toast_error_writing_data = Failed to write {$name} data
toast_error_loading_scripts = Failed to read Scripts (tried xScripts first): {$why}
toast_error_serializing_conf_data = Failed to serialize config data: {$why}
toast_error_writing_conf_data = Failed to write configuration data
toast_error_writing_data_why = Failed to write {$name} data: {$why}
toast_error_opening_dropped_proj = Error opening dropped project: {$why}
